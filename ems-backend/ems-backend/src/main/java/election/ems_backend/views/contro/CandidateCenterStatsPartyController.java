...
public class CandidateCenterStatsPartyController {
    ...
    public ResponseEntity<Page<CandidateCenterStatsPartyDto>> list(
            ...
            @RequestParam(value = "contestId", required = false) UUID contestId, // ✅ OPTIONAL (All contests supported)
        ...
        // ✅ 2) if missing, try X-Org-Id (set by OrgContextFilter)
        ...
        Page<CandidateCenterStatsPartyDto> result =
                service.listCandidateCenterStats(
                        effectiveOrgId,
                        electionId,
                        contestId,   // ✅ nullable => “All contests”
                        countyId,
                        districtId,
                        centerId,
                        candidateId,
...
//            @RequestParam(value = "electionId") UUID electionId,
//
//            // ✅ CHANGE: contestId optional (ALL contests when omitted)
...
//    ) {
//        if (electionId == null) return ResponseEntity.badRequest().build();
//        // ✅ REMOVED: contestId required check
//
//        // ✅ 1) try Security context (JWT-derived tenant)
//        UUID derivedOrgId = SecurityUtils.getOrgIdFromContext();
//
...
//        ).increment();
//
//        // ✅ CHANGE: pass contestId through (null means ALL contests)
//        Page<CandidateCenterStatsPartyDto> result =
//                service.listCandidateCenterStats(
//                        effectiveOrgId,
//                        electionId,
//                        contestId,   // ✅ now nullable (ALL)
//                        countyId,
//                        districtId,
//                        centerId,
//                        candidateId,
