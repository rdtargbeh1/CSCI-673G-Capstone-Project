...
/**
 * Read-only mapping for v_center_coverage_official.
 */
@Entity
@Table(name = "v_center_coverage_official")
@Immutable
@Getter
@NoArgsConstructor
public class CenterCoverageOfficial {

    @EmbeddedId
    private CenterCoverageOfficialId id;
