...
// // ✅ CHANGES ONLY (to match backend):
// // - ballotsCast  -> ballotsInBox   (DTO + create/update payloads)
// // - normalizeUpdatePayload now computes ballotsInBox (not ballotsCast)
// // - invalidTotal used for compute excludes spoiled (spoiled is OUTSIDE box)
...
//   // --- ballots ---
//   ballotsInBox?: number; // ✅ CHANGED (was ballotsCast)
