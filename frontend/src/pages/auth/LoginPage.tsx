...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center px-4">
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl border border-slate-200 p-10 text-center">
        ...
        >
          ...
          <div className="w-full">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 border rounded-lg text-center pr-14
                           focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
              ...
              <button
                ...
                className="absolute inset-y-0 right-4 text-sm font-medium text-slate-500 hover:text-slate-700"
              >
          ...
          <button
            ...
            className="w-full bg-blue-600 text-white py-3 rounded-lg
                       text-lg font-semibold hover:bg-blue-700 disabled:opacity-60 transition"
          >
