          ...
          <div className="flex w-full flex-wrap items-center gap-2 sm:max-w-3xl">
            <div className="relative w-full sm:max-w-xl">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-white py-2 pl-9 pr-3 text-sm outline-none focus:ring-2 focus:ring-(--org-primary) disabled:bg-slate-50"
              />
            </div>
            ...
            <input
              ...
              disabled={!hasOrgContext}
              className="w-full sm:w-56 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-(--org-primary) disabled:bg-slate-50"
            />
            ...
            <select
              ...
              disabled={!hasOrgContext}
              className="w-full sm:w-44 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-(--org-primary) disabled:bg-slate-50"
            >
...
// /** ---------------- API (tenant scoped; requires X-Org-Id) ---------------- */
// // ✅ Change this if your controller mapping is different:
// const BASE_URL = "/members";
...
//                 placeholder="Search members (name, username, email)…"
//                 disabled={!hasOrgContext}
//                 className="w-full rounded-xl border border-slate-200 bg-white py-2 pl-9 pr-3 text-sm outline-none focus:ring-2 focus:ring-[var(--org-primary)] disabled:bg-slate-50"
//               />
//             </div>
...
//               placeholder="Role filter (optional)"
//               disabled={!hasOrgContext}
//               className="w-full sm:w-56 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-[var(--org-primary)] disabled:bg-slate-50"
//             />
...
//               }}
//               disabled={!hasOrgContext}
//               className="w-full sm:w-44 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-[var(--org-primary)] disabled:bg-slate-50"
//             >
//               <option value="">All statuses</option>
//               <option value="true">Enabled</option>
//               <option value="false">Disabled</option>
...
//                   // dto shapes vary; keep it defensive
//                   const orgName =
//                     safeStr(m?.orgName) ||
//                     safeStr(m?.organizationName) ||
//                     safeStr(m?.organization?.orgName) ||
...
//                             ? `@${safeStr(m?.userName)}`
//                             : ""}
//                           {safeStr(m?.email) ? ` • ${safeStr(m?.email)}` : ""}
//                         </div>
//                       </td>
