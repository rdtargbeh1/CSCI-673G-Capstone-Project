...
// ✅ NEW (THIS REQUEST):
// 4) When FLAGGING a submission, require a REASON via a comment box (modal). Unflag stays as-is.
        ...
        >
          {!drawerRow ? (
            ...
            <div className="space-y-6">
              ...
              {/* MIDDLE ROW: Ballot Numbers (4 columns) */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                <Info
...
//                           <tr className="text-left">
//                             <th className="p-3 text-sm font-bold text-slate-600">
//                               Candidate
//                             </th>
...
//                         <tbody>
//                           {drawerVotes.map((r) => (
//                             <tr key={r.key} className="border-t hover:bg-slate-50 transition">
//                               <td className="p-3 text-base font-semibold text-slate-900">
//                                 {r.name}
//                               </td>
//                               <td className="p-3 text-base font-bold text-right text-slate-900">
...
//       <div className="absolute inset-y-0 right-0 p-4 flex items-start justify-end">
//         <div
//           className="
//             w-full
//             max-w-[600px]
...
//           onClick={(e) => e.stopPropagation()}
//         >
//           <div className="bg-gradient-to-r from-blue-50 to-white px-6 py-5 border-b border-slate-200 flex items-start justify-between gap-4">
//             <div className="min-w-0 flex-1">
